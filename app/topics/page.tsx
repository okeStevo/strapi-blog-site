...
const topics = [
  {
    title: "Generative AI",
    description:
      "Explore the latest advancements in generative AI models, including GANs, diffusion models, and more.",
  ...
  },
  {
    title: "Deep Learning",
    description:
      "Learn about neural network architectures, training techniques, and applications in various domains.",
  ...
  },
  {
    title: "AI Ethics",
    description:
      "Examine the ethical implications of AI development and deployment in society.",
    icon: <BrainCircuit className="h-6 w-6" />,
    count: 6,
    slug: "ai-ethics",
  },
  {
    ...
    description:
      "Explore how AI understands, generates, and interacts with human language.",
    icon: <BrainCircuit className="h-6 w-6" />,
    count: 9,
    slug: "nlp",
  },
  {
    title: "AI Research",
    description:
      "Stay updated with the latest research papers, breakthroughs, and academic developments in AI.",
    icon: <BrainCircuit className="h-6 w-6" />,
    count: 11,
    slug: "ai-research",
  },
      ...
      <header className="container mx-auto py-6">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-6 text-sm">
            ...
            <Link
              href="/topics/"
              className="text-white transition-colors border-b-2 border-purple-500 pb-1"
            >
              Topics
            </Link>
            <Link
